...
const products = [
  {
    ...
    imageUrl:
      "https://tailwindui.com/plus/img/ecommerce-images/product-page-02-secondary-product-shot.jpg",
    description:
  ...
  },
  {
    ...
    imageUrl:
      "https://tailwindui.com/plus/img/ecommerce-images/product-page-02-secondary-product-shot.jpg",
    description:
      "Comfortable headphones with noise cancellation and great sound quality.",
  },
];
